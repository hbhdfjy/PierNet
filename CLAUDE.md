...
- default embedding/tokenizer path: `/data/fjy/Qwen2.5-0.5B-Instruct`
...
- `start_ui.sh` defaults to `/home/fjy/miniconda3/envs/piern-project`; use `PIERN_CONDA_ENV` when the environment is named differently.
- `piern/training/services/training_manager.py` currently hardcodes `PYTHON_BIN = /home/fjy/miniconda3/envs/piern-project/bin/python`; check this before launching UI-created training jobs in an environment named differently.
