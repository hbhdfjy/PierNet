        ...
        <div className="page-content">
          {!hasRouterData && !sLoading && (
            <div className="flex-1 flex items-center justify-center">
              <EmptyState icon={GitBranch} title="暂无路由数据" description="请先在「路由数据生成」页面生成训练数据" />
            </div>
          )}
          ...
          {hasRouterData && (
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                ...
                {!samplesLoading &&
                  samplesResp?.items.map((s, i) => <SampleCard key={i} sample={s} index={page * PAGE_SIZE + i} />)}
