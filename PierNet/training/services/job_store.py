...
from PierNet.shared.tasks.state import normalize_status

TRAINING_JOB_STORE_PATH = Path(os.getenv("PierNet_TRAINING_JOB_STORE_PATH", RUNLOG_ROOT / "training_jobs.sqlite"))
