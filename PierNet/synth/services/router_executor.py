...
from PierNet.synth.services import job_manager, manifest_store
...
def run_router_build_job(record: JobRecord, payload: dict[str, Any]) -> None:
    ...
    max_workers = max(1, int(payload.get("max_workers") or os.getenv("PierNet_ROUTER_BUILD_WORKERS", "8")))
