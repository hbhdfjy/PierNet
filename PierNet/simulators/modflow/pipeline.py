...
from PierNet.simulators.modflow.generator import generate_batch, resolve_modflow_executable
from PierNet.simulators.modflow.generator_with_params import generate_batch_from_params
from PierNet.simulators.modflow.unified_params import UnifiedParamConverter
...
def augment_with_parameter_sampling(
    ...
    while len(pool_ts) < target_n:
        ...
        if max_workers > 1:
            ...
            from PierNet.simulators.modflow.generator import _generate_single_sample_worker
