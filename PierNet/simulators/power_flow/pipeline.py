...
from PierNet.simulators.power_flow.generator import generate_batch, _generate_single_worker
from PierNet.simulators.power_flow.generator_with_params import generate_batch_from_params
from PierNet.simulators.power_flow.unified_params import PowerFlowParamConverter
...
def run_pipeline(
    ...
    if aug_ts.shape[0] < n_samples:
        raise RuntimeError(f'潮流有效样本不足，仅得到 {aug_ts.shape[0]}/{n_samples} 条')
